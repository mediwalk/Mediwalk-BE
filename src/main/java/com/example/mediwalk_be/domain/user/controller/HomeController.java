...
public class HomeController {
	...
	@GetMapping
	@Operation(summary = "홈(리워드 메인) 요약", description = "총 적립 리워드, 이번·지난 달 적립(해당 월 거래일 기준 ACCUMULATION 합계·모든 적립 유형 포함), 증가율, 누적 수거 횟수(totalCollectionsCount), 달성 목표(설명·카테고리 포함), 최근 적립·환급 내역을 반환합니다.")
